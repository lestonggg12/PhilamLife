...
function AppContent() {
  ...
  useEffect(() => {
    ...
    // Keep in sync if session changes (e.g. token refresh, logout elsewhere)
    ...
    <Routes>
      ...
      <Route element={
        ...
        <Route path="/treasurer/dashboard" element={
          <ProtectedRoute isAuthenticated={isAuthenticated} user={user} allowedRoles={['treasurer']}>
            <TreasurerDashboard />
          </ProtectedRoute>
        } />
        <Route path="/secretary/dashboard" element={
          <ProtectedRoute isAuthenticated={isAuthenticated} user={user} allowedRoles={['secretary']}>
            <SecretaryDashboard />
          </ProtectedRoute>
        } />
